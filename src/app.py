...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training and matches for competitive soccer",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice drills, friendly games, and skill building in basketball",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["liam@mergington.edu", "mia@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore drawing, painting, and gallery projects",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["chloe@mergington.edu", "jack@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse plays, improv, and performance techniques",
